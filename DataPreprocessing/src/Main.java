...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        boolean  genTestSet  = args[5].equals("1");
        ...
        if (boundingBox){
            ...
            testArffPath = pathPrefix + "BB_TestArffs/";
        }
        else if (!boundingBox){
        ...
        float maxVpinHammingDis = generateTrainingData(dataEntries, vpinIDNums, trainFileName, scalingFactor, boundingBox);
        if (genTestSet)
